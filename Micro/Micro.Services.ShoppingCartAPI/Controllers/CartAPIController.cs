...
namespace Micro.Services.ShoppingCartAPI.Controllers
{
    ...
    public class CartAPIController : ControllerBase
    {
        ...
        [HttpPost("RemoveAll")]
        public async Task<ResponseDto> RemoveAll([FromBody] int cartHeaderId)
        {
            try
            {
                var cartDetails = _db.CartDetails.Where(u => u.CartHeaderId == cartHeaderId).ToList();
